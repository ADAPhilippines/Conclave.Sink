...
//                                         var inputBatches = transaction.Inputs.Batch(20);
//                                         foreach (var inputBatch in inputBatches) await Task.WhenAll(inputBatch.Select(reducer.HandleReduceAsync));
//                                         break;
//                                     case OuraVariant.TxOutput:
//                                         if (transaction.Outputs is null) break;
//                                         var outputBatches = transaction.Outputs.Batch(20);
//                                         foreach (var outputBatch in outputBatches) await Task.WhenAll(outputBatch.Select(reducer.HandleReduceAsync));
//                                         break;
//                                     default:
//                                         break;
//                                 }
