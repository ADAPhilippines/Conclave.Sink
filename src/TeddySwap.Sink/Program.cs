...
builder.Services.AddPooledDbContextFactory<TeddySwapNftSinkDbContext>(options =>
{
    options.UseNpgsql(builder.Configuration.GetConnectionString("TeddySwapSink"), npgsqlOptionsAction: o =>
    {
